...
# Particle Flow Isolation with delta beta correction
from HiggsAnalysis.HiggsToZZ4Leptons.hTozzTo4leptonsPFIsolationProducer_cff import *

## 
# Filter to select 2l2tau events
from HiggsAnalysis.HiggsToZZ4Leptons.phiplusplusMCGenProducer_cfi import *
import HiggsAnalysis.HiggsToZZ4Leptons.phiplusplusMCGenProducer_cfi
...
if useSkimEarlyData == 'true':
    ...
    hTozzTo4leptonsElectronSelector.electronEtaMax=cms.double(10.)
    ...
    hTozzTo4leptonsMuonSelector.muonPMinEndcap=cms.double(0.)
    hTozzTo4leptonsMuonSelector.muonPtMinEndcap=cms.double(0.)
    hTozzTo4leptonsMuonSelector.muonPtMinBarrel=cms.double(0.)
    hTozzTo4leptonsMuonSelector.muonEtaMax=cms.double(10.)
...
from HiggsAnalysis.HiggsToZZ4Leptons.MuTauSelect_cfi import *
...
zToMuTaucleaned = cms.EDProducer("HZZ4LeptonsCandViewCleaner",
                                 srcObject = cms.InputTag("mutauvispairs:visMuHPSTaucands"),
                                 srcObjectsToRemove = cms.InputTag("mutauvispairs:visMuHPSTaucands"),
                                 #deltaRMin = cms.double(0.2),
...
zToETaucleaned = cms.EDProducer("HZZ4LeptonsCandViewCleaner",
                                srcObject = cms.InputTag("mutauvispairs:visEleHPSTaucands"),
                                srcObjectsToRemove = cms.InputTag("mutauvispairs:visEleHPSTaucands"),
                                #deltaRMin = cms.double(0.2),
...
zToTauTaucleaned = cms.EDProducer("HZZ4LeptonsCandViewCleaner",
                                srcObject = cms.InputTag("mutauvispairs:visHPSTauHPSTaucands"),
                                srcObjectsToRemove = cms.InputTag("mutauvispairs:visHPSTauHPSTaucands"),
                                #deltaRMin = cms.double(0.2),
...
#hTozzToEEET.decay = cms.string('zToEEcleaned mutauvispairs:visEleHPSTaucands')
...
hTozzTo4leptonsCommonRootTreePresel.rootFileName = cms.untracked.string('roottree_phiplusplus.root')
# hlt
...
hTozzTo4leptonsCommonRootTreePresel.fillPUinfo = cms.untracked.bool(True)
#hTozzTo4leptonsCommonRootTreePresel.triggerEvent  = cms.InputTag("hltTriggerSummaryAOD","","REDIGI311X")
#hTozzTo4leptonsCommonRootTreePresel.triggerFilter = cms.string('hltDiMuonL3PreFiltered5')
...
hTozzTo4leptonsCommonRootTreePresel.fillRF = cms.untracked.bool(True) 
hTozzTo4leptonsCommonRootTreePresel.RECOcollNameBestRestFrame2e2mu = cms.VInputTag(cms.InputTag("hTozzTo4leptonsHiggsFrame:hToZZTo4LeptonsHiggsRestFrameMother"), cms.InputTag("hTozzTo4leptonsHiggsFrame:hToZZTo4LeptonsHiggsRestFrameBoson0"), cms.InputTag("hTozzTo4leptonsHiggsFrame:hToZZTo4LeptonsHiggsRestFrameBoson1"))
hTozzTo4leptonsCommonRootTreePresel.RECOcollNameBestRestFrame4mu = cms.VInputTag(cms.InputTag("hTozzTo4leptonsHiggsFrameMMMM:hToZZTo4LeptonsHiggsRestFrameMother"), cms.InputTag("hTozzTo4leptonsHiggsFrameMMMM:hToZZTo4LeptonsHiggsRestFrameBoson0"), cms.InputTag("hTozzTo4leptonsHiggsFrameMMMM:hToZZTo4LeptonsHiggsRestFrameBoson1"))
hTozzTo4leptonsCommonRootTreePresel.RECOcollNameBestRestFrame4e = cms.VInputTag(cms.InputTag("hTozzTo4leptonsHiggsFrameEEEE:hToZZTo4LeptonsHiggsRestFrameMother"), cms.InputTag("hTozzTo4leptonsHiggsFrameEEEE:hToZZTo4LeptonsHiggsRestFrameBoson0"), cms.InputTag("hTozzTo4leptonsHiggsFrameEEEE:hToZZTo4LeptonsHiggsRestFrameBoson1"))
...
phiplusplusSelectionSequence = cms.Sequence(
        phiplusplusMCGenProducer              +
#        hTozzTo4leptonsMCGenParticleListDrawer     +
...
#        hTozzTo4leptonsHiggsFrame                   +
#        hTozzTo4leptonsHiggsFrameEEEE               +
